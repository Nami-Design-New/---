...
!(function() {
  ...
  var s = document.querySelector("#swiper-with-pagination-cards"),
    ...
    // project _ details Elapsed period
    s = (
      null !== s && new ApexCharts(s, i).render(),
  ...
  s.length &&
    (
      s.DataTable({
        ...
        columnDefs: [
              ...
              return (
                ...
                (o
                  ...
                  : '<span class="avatar-initial rounded-circle bg-label-' +
                    ...
                    '">' +
                    (o = (((o =
                      (s = a.project_name).match(/\b\w/g) || []).shift() ||
                      "") + (o.pop() || "")).toUpperCase()) +
                    "</span>") +
          ...
          },
          {
            ...
            render: function(e, t, a, r) {
              for (
                var o = a.team,
                  s = '<div class="d-flex align-items-center avatar-group">',
                  i = 0;
                i < o.length;
                i++
              )
        ...
        order: [[2, "desc"]],
        dom:
          '<"card-header pb-0 pt-sm-0"<"head-label text-center"><"d-flex justify-content-center justify-content-md-end"f>>t<"row mx-2"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
        displayLength: 5,
